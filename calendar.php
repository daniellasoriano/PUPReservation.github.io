			...
			<div class = "modal-content ">
				...
				<div class="modal-body">
					...
					<div form = "form-horizontal">
						<form action='insertreservfac.php' method='post'>
...
<?php
 ...
 include('connection.php');
  $dateclick = "<script>document.write(selectDate)</script>";

  $sqlreserv = mysqli_query($con, "Select * from tblreservation order by dtmReservationDate, timReservationStart"); 
...
?>
  ...
  <?php 
  	...
  	?>
		  <form method = 'post'>
		  <input type = "submit" name="btnActive" value="Activate">
		  </form>
    <?php
